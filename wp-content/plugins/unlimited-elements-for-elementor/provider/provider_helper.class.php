...
class HelperProviderUC{
	 ...
	 */
	public static function startAPIIntegration(){
		
		$objAPI = new UniteCreatorAPIIntegrations();
		$objAPI->init();
	}
	...
	public static function globalInit(){
		...
		add_action("start_ue_api_integration",array("HelperProviderUC","startAPIIntegration"));
